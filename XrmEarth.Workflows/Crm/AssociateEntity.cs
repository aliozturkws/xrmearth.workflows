...
{
    public class AssociateEntity : BaseCodeActivity
    {
        protected override void OnExecute(CodeActivityHelper activityHelper)
        {
            ...
            WorkflowHelper.Associate(activityHelper.OrganizationService, targetRecordUrl, relationRecordUrl, relationShipName, relationShipEntityName);
        }
